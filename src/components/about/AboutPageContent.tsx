    ...
    <div className="portfolio-item-container">
      ...
      <div className="section project-about img4" id="about">
        <div className="biography">
          <div className="about-sticky-heading">
            <HoverHeading as="h1">Artist, Draughtsman &amp; Art Director</HoverHeading>
          </div>
      ...
      <div className="section project-about img6" id="keymer">
        <div className="biography-a">
          <div className="about-sticky-heading">
            <HoverHeading as="h2">D.J. Keymer, Bombay &amp; Calcutta</HoverHeading>
          </div>
          <p className="about-info">
      ...
      <div className="section project-about img8" id="calligraphy">
        <div className="biography">
          ...
          <p className="about-info">
            A surviving design reference sheet shows him setting out requirements
            for commissioned inscription work in great detail, including copy
            length, historical information to be supplied, preferred colour
            combinations and alternative geometric formats in which lettering
            could be arranged. His work included formal calligraphic layouts,
            inscription planning and decorative letterforms intended for
            presentation pieces and commemorative use.
          </p>
          <p className="about-info">
            His calligraphy and lettering were widely respected within his
            professional circle. In 1947, after being admitted as an Associate of
            the Incorporated Institute of British Decorators, William was invited
            to design a bookplate for the Institute&apos;s rebuilt library in
            London. Across these works, his lettering brought together an
            artistic eye with structure, balance, order and design craftsmanship.
          </p>
        </div>
      </div>
      ...
      <div className="section project-about img0" id="about">
        <div className="biography">
          <div className="about-sticky-heading">
            <HoverHeading as="h2">Detached Royal Engineers in India</HoverHeading>
          </div>
          <p className="about-info">
          ...
          <p className="about-info">
            ...
            wartime world of roads, river crossings, military movement, logistics
            and visual documentation. His work brought together practical
            engineering, draughtsmanship, public information and the discipline
      ...
      <div className="section project-about img3" id="about">
        ...
        <div className="biography-c">
          ...
          <p className="about-info">
            ...
            murals, lettering, industrial subjects, exhibition stands, pavilions,
            public displays and visual promotion.
          </p>
          <p className="about-info">
            This was also the context in which William produced studies of Indian
            architecture, sculpture and cave temples, including work connected to
            Cave 16, the Kailasa Temple at Ellora. Surviving archive references
            link these drawings to the wider Hyderabad archaeological world of
            Ellora documentation, placing them within a serious artistic,
            historical and institutional setting rather than as casual travel
            sketches.
          </p>
          <p className="about-info">
      ...
      <div className="section project-about img2" id="about">
        <div className="biography-b">
          ...
          <p className="about-info">
            ...
            family tradition of professional discipline, public service and medical
            life.
          </p>
          <p className="about-info">
          ...
          <p className="about-info">
            ...
            paintings, drawings, photographs, cave studies, exhibition designs and
            studies of daily life — not as distant travel imagery, but as part of
            the lived world that shaped his family, his career and his
      ...
      <div className="section project-about img5" id="about">
        <div className="biography">
          ...
          <p className="about-info">
            ...
            own right. They show the same attention to composition that shaped his
            paintings, exhibition design and art direction. Seen together, the
            photographs help reveal how he looked at the world before translating
            it into drawing, paint, lettering or design.
          </p>
        </div>
      </div>
    </div>
